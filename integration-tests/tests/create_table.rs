...
async fn table_data_types(
    ...
    assert_eq!(
        table_str,
        r#"+-------------------+-------------+----------+-----------+-------------+----------------------+-----------+------------+------------+----------------------+---------------+-------------------------+----------------------+---------------------------+----------------------------+-------------------------------+--------------+-------------------------+-------------------+------------------------+------------------------+-----------------------+------------+-----------------------+------------------+-----------------+----------+----------------+---------------+------------------------------------------+--------------------------------------------------------------------------------+
| _indexlake_row_id | boolean_col | int8_col | int16_col | int32_col   | int64_col            | uint8_col | uint16_col | uint32_col | uint64_col           | float32_col   | float64_col             | timestamp_second_col | timestamp_millisecond_col | timestamp_microsecond_col  | timestamp_nanosecond_col      | date32_col   | date64_col              | time32_second_col | time32_millisecond_col | time64_microsecond_col | time64_nanosecond_col | binary_col | fixed_size_binary_col | large_binary_col | binary_view_col | utf8_col | large_utf8_col | utf8_view_col | decimal128_col                           | decimal256_col                                                                 |
+-------------------+-------------+----------+-----------+-------------+----------------------+-----------+------------+------------+----------------------+---------------+-------------------------+----------------------+---------------------------+----------------------------+-------------------------------+--------------+-------------------------+-------------------+------------------------+------------------------+-----------------------+------------+-----------------------+------------------+-----------------+----------+----------------+---------------+------------------------------------------+--------------------------------------------------------------------------------+
| 1                 | false       | -128     | -32768    | -2147483648 | -9223372036854775808 | 0         | 0          | 0          | 0                    | -3.4028235e38 | -1.7976931348623157e308 | 1970-01-01T00:00:00  | 1970-01-01T00:00:00       | 1970-01-01T00:00:00        | 1970-01-01T00:00:00           | 1970-01-01   | 1970-01-01T00:00:00     | 00:00:00          | 00:00:00               | 00:00:00               | 00:00:00              | 0001       | 0001                  | 0001             | 0001            | utf8     | largeutf8      | utf8view      | -1701411834604692317316873037.1588410572 | -578960446186580977117854925043439539266349923328202820197287920039.5656481996 |
| 2                 | true        | 127      | 32767     | 2147483647  | 9223372036854775807  | 255       | 65535      | 4294967295 | 18446744073709551615 | 3.4028235e38  | 1.7976931348623157e308  | 1970-05-09T14:25:11  | 1970-01-01T03:05:11.111   | 1970-01-01T00:00:11.111111 | 1970-01-01T00:00:00.011111111 | +32391-03-11 | 1970-01-01T03:05:11.111 | 00:18:31          | 03:05:11.111           | 00:00:11.111111        | 00:00:00.011111111    | 0001       | 0001                  | 0001             | 0001            | utf8     | largeutf8      | utf8view      | 1701411834604692317316873037.1588410572  | 578960446186580977117854925043439539266349923328202820197287920039.5656481996  |
| 3                 |             |          |           |             |                      |           |            |            |                      |               |                         |                      |                           |                            |                               |              |                         |                   |                        |                        |                       |            |                       |                  |                 |          |                |               |                                          |                                                                                |
+-------------------+-------------+----------+-----------+-------------+----------------------+-----------+------------+------------+----------------------+---------------+-------------------------+----------------------+---------------------------+----------------------------+-------------------------------+--------------+-------------------------+-------------------+------------------------+------------------------+-----------------------+------------+-----------------------+------------------+-----------------+----------+----------------+---------------+------------------------------------------+--------------------------------------------------------------------------------+"#,
    );
